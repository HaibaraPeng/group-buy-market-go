...
func (s *SwitchRoot) Apply(requestParameter *model.MarketProductEntity, dynamicContext *trial.DynamicContext) (*model.TrialBalanceEntity, error) {
...
func (s *SwitchRoot) Get(requestParameter *model.MarketProductEntity, dynamicContext *trial.DynamicContext) (trial.StrategyHandler, error) {
...
var _ trial.StrategyHandler = (*SwitchRoot)(nil)
