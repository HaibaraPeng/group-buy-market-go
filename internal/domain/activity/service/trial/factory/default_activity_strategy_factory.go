...
type DefaultActivityStrategyFactory struct {
	rootNode core.StrategyHandler
}

// NewDefaultActivityStrategyFactory 创建默认活动策略工厂
func NewDefaultActivityStrategyFactory(rootNode core.StrategyHandler) *DefaultActivityStrategyFactory {
...
func (f *DefaultActivityStrategyFactory) StrategyHandler() core.StrategyHandler {
	return f.rootNode
}
