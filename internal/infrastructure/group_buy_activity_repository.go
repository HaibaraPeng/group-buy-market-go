...
func (r *MySQLGroupBuyActivityRepository) Save(activity *po.GroupBuyActivity) error {
	return r.db.Save(activity).Error
}

// FindByID finds a group buy activity by ID
func (r *MySQLGroupBuyActivityRepository) FindByID(id int64) (*po.GroupBuyActivity, error) {
...
func (r *MySQLGroupBuyActivityRepository) FindByActivityID(activityID int64) (*po.GroupBuyActivity, error) {
	var activity po.GroupBuyActivity
...
func (r *MySQLGroupBuyActivityRepository) FindAll() ([]*po.GroupBuyActivity, error) {
