...
func NewHTTPServer(c *conf.Server, marketService *service.ActivityService, tagService *service.TagService, dccService *service.DccService, logger log.Logger) *http.Server {
