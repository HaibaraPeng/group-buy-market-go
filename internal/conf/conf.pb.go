...
type Data_RabbitMQ struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Addresses     string                 `protobuf:"bytes,1,opt,name=addresses,proto3" json:"addresses,omitempty"`                               // Addresses
...
func (x *Data_RabbitMQ) GetAddresses() string {
	if x != nil {
		return x.Addresses
	}
	return ""
...
func (x *Data_RabbitMQ) GetProducer() *Data_RabbitMQProducer {
	if x != nil {
		return x.Producer
	}
	return nil
...
type Data_RabbitMQProducer struct {
	state            protoimpl.MessageState    `protogen:"open.v1"`
	Exchange         string                    `protobuf:"bytes,1,opt,name=exchange,proto3" json:"exchange,omitempty"`                                           // Exchange name for producer
	TopicTeamSuccess *Data_RabbitMQTopicConfig `protobuf:"bytes,2,opt,name=topic_team_success,json=topicTeamSuccess,proto3" json:"topic_team_success,omitempty"` // Topic configuration
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *Data_RabbitMQProducer) Reset() {
	*x = Data_RabbitMQProducer{}
	mi := &file_internal_conf_conf_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Data_RabbitMQProducer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_RabbitMQProducer) ProtoMessage() {}

func (x *Data_RabbitMQProducer) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_RabbitMQProducer.ProtoReflect.Descriptor instead.
func (*Data_RabbitMQProducer) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 3}
}

func (x *Data_RabbitMQProducer) GetExchange() string {
	if x != nil {
		return x.Exchange
	}
	return ""
...
func (x *Data_RabbitMQProducer) GetTopicTeamSuccess() *Data_RabbitMQTopicConfig {
	if x != nil {
		return x.TopicTeamSuccess
	}
	return nil
}

type Data_RabbitMQTopicConfig struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RoutingKey    string                 `protobuf:"bytes,1,opt,name=routing_key,json=routingKey,proto3" json:"routing_key,omitempty"` // Routing key for topic
	Queue         string                 `protobuf:"bytes,2,opt,name=queue,proto3" json:"queue,omitempty"`                             // Queue name for topic
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Data_RabbitMQTopicConfig) Reset() {
	*x = Data_RabbitMQTopicConfig{}
	mi := &file_internal_conf_conf_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Data_RabbitMQTopicConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_RabbitMQTopicConfig) ProtoMessage() {}

func (x *Data_RabbitMQTopicConfig) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_RabbitMQTopicConfig.ProtoReflect.Descriptor instead.
func (*Data_RabbitMQTopicConfig) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 4}
}

func (x *Data_RabbitMQTopicConfig) GetRoutingKey() string {
	if x != nil {
		return x.RoutingKey
	}
	return ""
...
func (x *Data_RabbitMQTopicConfig) GetQueue() string {
	if x != nil {
		return x.Queue
	}
	return ""
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x13RabbitMQTopicConfig\x12\x1f\n" +
	"\vrouting_key\x18\x01 \x01(\tR\n" +
	"routingKey\x12\x14\n" +
	"\x05queue\x18\x02 \x01(\tR\x05queueB(Z&group-buy-market-go/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Data_RabbitMQProducer)(nil),    // 8: kratos.api.Data.RabbitMQProducer
	(*Data_RabbitMQTopicConfig)(nil), // 9: kratos.api.Data.RabbitMQTopicConfig
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 12: kratos.api.Data.RabbitMQ.producer:type_name -> kratos.api.Data.RabbitMQProducer
	9,  // 13: kratos.api.Data.RabbitMQProducer.topic_team_success:type_name -> kratos.api.Data.RabbitMQTopicConfig
