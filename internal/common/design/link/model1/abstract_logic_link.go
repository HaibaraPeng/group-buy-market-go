...
func (r *AbstractLogicLink[T, D, R]) SetDoApplyFunc(f func(requestParameter T, dynamicContext D) (R, error)) {
	r.doApplyFunc = f
}

// Apply 业务流程受理 - 可以被子类重写或使用设置的函数
func (r *AbstractLogicLink[T, D, R]) Apply(requestParameter T, dynamicContext D) (R, error) {
