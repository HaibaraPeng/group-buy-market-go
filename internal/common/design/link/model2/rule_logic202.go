...
func (rl *RuleLogic202) Apply(requestParameter string, dynamicContext *DynamicContext) (*XxxResponse, error) {
...
func (rl *RuleLogic202) Next(requestParameter string, dynamicContext *DynamicContext) (*XxxResponse, error) {
