...
func (rl *Model2RuleLogic1) Apply(ctx context.Context, requestParameter string, dynamicContext *DynamicContext) (*XxxResponse, error) {
	log.Println("link model02 Model2RuleLogic1")

	return rl.Next(ctx, requestParameter, dynamicContext)
}

// Next 是Model2RuleLogic1的下一个处理逻辑
func (rl *Model2RuleLogic1) Next(ctx context.Context, requestParameter string, dynamicContext *DynamicContext) (*XxxResponse, error) {
