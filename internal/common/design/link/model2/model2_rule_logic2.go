...
func (rl *Model2RuleLogic2) Apply(requestParameter string, dynamicContext *DynamicContext) (*XxxResponse, error) {
...
func (rl *Model2RuleLogic2) Next(requestParameter string, dynamicContext *DynamicContext) (*XxxResponse, error) {
